...
|----------|-------------|
| [System Architecture](architecture/architecture-overview.md) | Comprehensive architecture overview: module system, runtime, scoping, parsing, and all core subsystems |
