...
|----------|-------------|
| [System Architecture](architecture/new-architecture.md) | Comprehensive architecture overview: module system, runtime, scoping, parsing, and all core subsystems |
