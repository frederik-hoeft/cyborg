...
internal sealed class ExecutionTransactionForkGroup
{
    ...
    private ExecutionTransactionForkLifecycle _lifecycle;

    internal ExecutionTransactionForkGroup(
        ExecutionTransaction owner,
        ...
        TransactionStateBundle ownerState)
    {
        ...
        _lifecycle = ExecutionTransactionForkLifecycle.Active;
    }

    public ExecutionTransaction Continuation { get; }

    public ExecutionTransactionForkLifecycle Lifecycle => _lifecycle;
    ...
    public bool TryJoin(out TransactionConflict? conflict)
    {
        ...
        _lifecycle = ExecutionTransactionForkLifecycle.Joined;
        conflict = null;
        return true;
    }
    ...
    public void Discard()
    {
        ...
        _lifecycle = ExecutionTransactionForkLifecycle.Discarded;
    }
    ...
    {
        if (_lifecycle != ExecutionTransactionForkLifecycle.Active)
        {
            throw new InvalidOperationException($"Fork group state is '{_lifecycle}' and cannot be used for this operation.");
        }
    }
