...
internal sealed record DebugPauseContext(IModule Module, string ModuleId, IModuleRuntime Runtime, IBreakpointRegistry Breakpoints, Action RequestStepAction, Action DetachAction)
    : IDebugPauseContext
{
