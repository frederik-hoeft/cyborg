...
public sealed record DefaultDescriptionPropertyComponent(string Name, IDescriptionValueComponent Value, ImmutableArray<string> Hints) : IDescriptionPropertyComponent
{
