    ...
    IDescriptionComponentFactory
{
        ...
        ImmutableArray<string> hints)
    {
        ...
        return new DefaultDescriptionPropertyComponent(
            name,
            value,
            hints.OrEmpty());
    }

    public IDescriptionValueComponent CreateValue<T>(
        T value,
        ImmutableArray<string> hints)
        => new DefaultDescriptionValueComponent<T>(
            value,
            hints.OrEmpty());
    ...
    public IDescriptionObjectComponent CreateObject(
        ...
        ImmutableArray<string> hints)
        => new DefaultDescriptionObjectComponent(
            properties.OrEmpty(),
            hints.OrEmpty());
    ...
    public IDescriptionCollectionComponent CreateCollection(
        ...
        ImmutableArray<string> hints)
        => new DefaultDescriptionCollectionComponent(
            items.OrEmpty(),
            hints.OrEmpty());
}
