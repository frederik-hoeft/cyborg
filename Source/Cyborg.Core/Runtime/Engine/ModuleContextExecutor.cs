...
internal sealed class ModuleContextExecutor(VariableSyntaxBuilder syntaxFactory, IRuntimeEnvironmentFactory environmentFactory, ILoggerFactory loggerFactory) : IModuleContextExecutor
{
